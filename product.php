...
<html lang="es">
<head>
    <title>Mi Burrito Sabanero - Productos</title>
       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">Mi Burrito Sabanero</small></h1>
            </div>
            <?php
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                              <button class="btn btn-primary btn-sm btn-raised btn-block" type="submit">Buscar</button>
                          </span>
                        </div>
                      </div>
                    </form>
