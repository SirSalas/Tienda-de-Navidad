...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo"><img src="assets/img/emoticon.png" alt="Icono de Burrito" style="vertical-align: middle; margin-right: 10px; width: 40px; height: 40px;">MI BURRITO SABANERO</p>
            </div>
            <div class="col-xs-8">
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">MI BURRITO SABANERO</h3>
